  ...
  return (
    <div className="max-w-5xl mx-auto px-4 py-8">
      <Card className="overflow-hidden shadow-lg border-2">
        <div className="h-32 bg-zinc-950 dark:bg-zinc-900 relative">
        ...
        <div className="pt-20 pb-8 px-8">
          ...
          <div className="mt-8">
            ...
            <div className="grid md:grid-cols-2 gap-4">
              <div className="flex items-center gap-3 p-4 rounded-lg border hover:border-red-500 transition-colors">
          ...
          {user.role === "jobseeker" && user.resume && (
            <div className="mt-8">
              ...
              <div className="flex items-center gap-3 p-4 rounded-lg border hover:border-red-500 transition-colors">
                <div className="h-12 w-12 rounded-lg bg-red-100 dark:bg-red-950/20 flex items-center justify-center">
                  <NotepadText size={20} className="text-red-500" />
                </div>
